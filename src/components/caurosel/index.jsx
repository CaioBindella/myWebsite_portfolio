...
export default function Caurosel(){
    return(
        <div className="carrosel" id="portifolio">
            <h1 className="TextPortifolio">Portifólio</h1>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <p>Site Institucional para Empresa Serra Jr. Engenharia - 2022</p>
                </div>
                </div>
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <p>Site Institucional para o laboratório Nanofab localizado na UERJ Maracanã - 2023</p>
                </div>
                </div>
                <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <p>Site para o evento Cervejelas em teresópolis - 2023</p>
                </div>
                </div>
                <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h1>App Rotas</h1>
                    <p>Aplicativo de otimização de rotas focado em logística - 2024</p>
                </div>
                </div>
                <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h1>App ISOAS</h1>
                    <p>Aplicativos de Índice de Sustentabilidade Operacional de Aterros Sanitários - 2023</p>
                </div>
                </div>
            </div>
